...
<Section id="sec-3" title="3. ClickUp" depth={1} />
<p>The following section defines the principal structures, entities, features, and behaviors provided
  ...
  consistent reference for understanding the platform's logic, capabilities, and constraints.</p>
      <Section id="sec-3-1" title="3.1 Base Scope" depth={2} />
      ...
      <Section id="sec-3-1-1" title="3.1.1 Base Scope Table" depth={3} />
      <DocTable id="base-scope">
          <thead>
            <tr>
              <th>Name</th>
              <th>Description</th>
      ...
      <Section id="sec-3-1-2" title="3.1.2 ClickUp's Inadequacy" depth={3} />
      <p>ClickUp has one core object: a task. So no matter what you’re trying to model, every entry is forced to inherit
        ...
        across ClickUp.</p>
      <Section id="sec-3-2" title="3.2 Custom Fields" depth={2} />
      ...
      <Section id="sec-3-3" title="3.3 Field Types" depth={2} />
      ...
      <Section id="sec-3-3-1" title="3.3.1 System-Only Field Types" depth={3} />
      ...
      <Section id="sec-3-3-2" title="3.3.2 Parameterized Field Types" depth={3} />
      ...
      <Section id="sec-3-3-3" title="3.3.3 Computational Field Types" depth={3} />
      <p>Some fields represent derived values rather than directly-entered values. Examples include Formula and Progress
        (Auto).</p>
      <Section id="sec-3-3-4" title="3.3.4 AI Field Types" depth={3} />
      ...
      <Section id="sec-3-3-5" title="3.3.5 Scope-Selecting Field Types" depth={3} />
      ...
      <Section id="sec-3-3-6" title="3.3.6 Field Types Table" depth={3} />
      <DocTable id="field-types">
          <thead>
            <tr>
              <th>Field type</th>
              <th>Description</th>
      ...
      <Section id="sec-3-4" title="3.4 Scopes" depth={2} />
      ...
      <Section id="sec-3-4-1" title="3.4.1 Location Scope Hierarchy" depth={3} />
      ...
      <Section id="sec-3-4-2" title="3.4.2 Task Type Scope Hierarchy" depth={3} />
